...
NSUBJ_MLN_PREDICATE = PRED_PATTERN.format(SLOT_VALUE_NSUBJ)
DOBJ_MLN_PREDICATE = PRED_PATTERN.format(SLOT_VALUE_DOBJ)
IOBJ_MLN_PREDICATE = PRED_PATTERN.format(SLOT_VALUE_IOBJ)
PREPOBJ_MLN_PREDICATE = PRED_PATTERN.format(SLOT_VALUE_PREPOBJ)
...
JSON_HOWTO_ACTIONCORE_ROLES = JSON_FRAME_ACTIONCORE_ROLES
