...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.mathjax', 'sphinxcontrib.bibtex']
...
# of the sidebar.
html_logo = os.path.join('_static', 'prac-brightondark-transp.png')
...
latex_documents = [
  ('index', 'PRAC.tex', u'PRAC Documentation',
...
texinfo_documents = [
  ('index', 'PRAC', u'PRAC Documentation',
   u'Daniel Nyga', 'PRAC', 'One line description of project.',
   'Miscellaneous'),
]
