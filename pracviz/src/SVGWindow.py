...
class SVGWidget(FocusWidget):
    def __init__(self, imgPath, className='svg'):
        element = DOM.createElement('svg')
    ...
    def draw_elements(self):
        ...
        <object data="prac_logo_2.svg" type="image/svg+xml width="100%" height="100%" />
          ''')
        elif svg_method == 1:
            DOM.setInnerHTML(self.svg_area, '''
        ...
        <polygon id="triangle" points="2,20 22,20 12,40" fill="black" stroke="blue" stroke-width="1" />
          ...
          ''')
            ...
            self.svg_area.setAttribute("src", self.file)
