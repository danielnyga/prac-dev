...
% \usepackage{epsfig}
% \usepackage{pst-grad} % For gradient3s
...
(e.g. modals). The verbalizer system being purely a DRS and PRAC based syntactical 
manipulator, is constrained by the current implemented 
