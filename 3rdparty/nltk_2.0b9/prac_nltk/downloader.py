...
try:
    ...
    from prac_nltk.draw.table import Table
    from prac_nltk.draw import ShowText
except:
    TKINTER = False
    TclError = ValueError

from prac_nltk.etree import ElementTree
...
def _find_packages(root):
    ...
    """
    from prac_nltk.corpus.reader.util import _path_from
    # Find all packages.
    packages = []
    for dirname, subdirs, files in os.walk(root):
