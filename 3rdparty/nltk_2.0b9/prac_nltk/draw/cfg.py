...
from prac_nltk.grammar import ContextFreeGrammar, Nonterminal, parse_cfg_production
...
def demo2():
    from prac_nltk import Nonterminal, Production, ContextFreeGrammar
...
def demo():
    from prac_nltk import Nonterminal, parse_cfg
    nonterminals = 'S VP NP PP P N Name V Det'
    (S, VP, NP, PP, P, N, Name, V, Det) = [Nonterminal(s)
                                           for s in nonterminals.split()]
...
def demo3():
    from prac_nltk import Production
