...
from prac_nltk.corpus import machado, mac_morpho, floresta, genesis
from prac_nltk.text import Text
from prac_nltk.probability import FreqDist
from prac_nltk.util import bigrams
from prac_nltk.misc import babelize_shell
