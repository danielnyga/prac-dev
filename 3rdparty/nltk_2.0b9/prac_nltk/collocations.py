...
from prac_nltk.compat import any
from prac_nltk.probability import FreqDist
from prac_nltk.util import ingrams
from prac_nltk.metrics import ContingencyMeasures, BigramAssocMeasures, TrigramAssocMeasures
from prac_nltk.metrics.spearman import *
...
def demo(scorer=None, compare_scorer=None):
    ...
    from prac_nltk.metrics import BigramAssocMeasures, spearman_correlation, ranks_from_scores
...
if __name__ == '__main__':
    import sys
    from prac_nltk.metrics import BigramAssocMeasures
    try:
