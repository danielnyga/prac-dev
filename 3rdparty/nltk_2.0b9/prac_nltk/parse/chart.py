...
from prac_nltk.grammar import WeightedGrammar, is_nonterminal, is_terminal
...
def demo_grammar():
    from prac_nltk.grammar import parse_cfg
    return parse_cfg("""
S  -> NP VP
PP -> "with" NP
NP -> NP PP
...
def demo(choice=None,
    ...
    """
    import sys, time
    from prac_nltk import nonterminals, Production, ContextFreeGrammar
