...
from prac_nltk.tree import Tree, ProbabilisticTree
from prac_nltk.grammar import Nonterminal, WeightedGrammar
...
def demo(choice=None, draw_parses=None, print_parses=None):
    ...
    """
    import sys, time
    from prac_nltk import tokenize, toy_pcfg1, toy_pcfg2
    ...
    if draw_parses:
        from prac_nltk.draw.tree import draw_trees
        print '  please wait...'
        draw_trees(*parses)
