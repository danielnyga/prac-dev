...
from prac_nltk.corpus.reader import CorpusReader
from prac_nltk.util import binary_search_file as _binary_search_file
...
#                            for root in h.root_hypernyms()))
    ...
    def closure(self, rel, depth=-1):
        ...
        """
        from prac_nltk.util import breadth_first
        synset_offsets = []
