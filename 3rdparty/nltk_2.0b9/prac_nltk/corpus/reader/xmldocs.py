...
from prac_nltk.tokenize import WordPunctTokenizer
from prac_nltk.internals import deprecated, ElementWrapper

from prac_nltk.corpus.reader.api import CorpusReader
