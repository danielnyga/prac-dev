...
except ImportError: from prac_nltk.etree import ElementTree

from prac_nltk.tokenize import wordpunct_tokenize
from prac_nltk.internals import deprecated, slice_bounds
from prac_nltk.data import PathPointer, FileSystemPathPointer, ZipFilePathPointer
from prac_nltk.data import SeekableUnicodeStreamReader
from prac_nltk.sourcedstring import SourcedStringStream
from prac_nltk.util import AbstractLazySequence, LazySubsequence, LazyConcatenation
