...
from prac_nltk.data import show_cfg
from prac_nltk.sem import root_semrep, Expression
from mace import MaceCommand
from prover9 import Prover9Command
from prac_nltk.tag import RegexpTagger
from prac_nltk.parse.malt import MaltParser
from prac_nltk.sem.drt import resolve_anaphora, AnaphoraResolutionException
from prac_nltk.sem.glue import DrtGlue
...
def parse_fol(s):
    ...
    """
    from prac_nltk.sem import LogicParser
    statements = []
    lp = LogicParser()
