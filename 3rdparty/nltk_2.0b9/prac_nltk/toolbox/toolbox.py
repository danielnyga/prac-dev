...
from prac_nltk.etree.ElementTree import TreeBuilder, Element, SubElement
from prac_nltk.data import PathPointer, ZipFilePathPointer
...
class ToolboxData(StandardFormat):
    ...
    def _tree2etree(self, parent):
        from prac_nltk.parse import Tree
...
#    lexicon = ToolboxData(ZipFilePathPointer(zip_path, 'toolbox/rotokas.dic')).parse()
    ...
    from prac_nltk.etree.ElementTree import ElementTree
