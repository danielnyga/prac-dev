...
#from prac_nltk.util import Deprecated
import prac_nltk.classify.util # for accuracy & log_likelihood
from prac_nltk.util import LazyMap
...
def names_demo(trainer, features=names_demo_features):
    from prac_nltk.corpus import names
    import random
...
def wsd_demo(trainer, word, features, n=1000):
    from prac_nltk.corpus import senseval
    import random
