...
def names_demo():
    ...
    from prac_nltk.classify.maxent import TadmMaxentClassifier
    classifier = names_demo(TadmMaxentClassifier.train)               

def encoding_demo():
    import sys
    from prac_nltk.classify.maxent import TadmEventMaxentFeatureEncoding
    from prac_nltk.classify.tadm import write_tadm_file
