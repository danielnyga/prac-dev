...
from prac_nltk.probability import FreqDist, LidstoneProbDist
from prac_nltk.probability import ConditionalFreqDist as CFD
from prac_nltk.compat import defaultdict
from prac_nltk.util import tokenwrap, LazyConcatenation
from prac_nltk.model import NgramModel
from prac_nltk.metrics import f_measure, BigramAssocMeasures
from prac_nltk.collocations import BigramCollocationFinder
...
class Text(object):
    ...
    def collocations(self, num=20, window_size=2):
        ...
        if not ('_collocations' in self.__dict__ and self._num == num and self._window_size == window_size):
            ...
            from prac_nltk.corpus import stopwords
    ...
    def readability(self, method):
        # code from prac_nltk_contrib.readability
...
#        words = self._word_context_index.similar_words(word, num)
    ...
    def dispersion_plot(self, words):
        ...
        """
        from prac_nltk.draw import dispersion_plot
