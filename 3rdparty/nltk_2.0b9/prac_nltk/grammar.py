...
from prac_nltk.internals import deprecated
from prac_nltk.compat import all
from prac_nltk.util import transitive_closure, invert_graph
...
def cfg_demo():
    ...
    from prac_nltk import nonterminals, Production, parse_cfg
...
def pcfg_demo():
    ...
    from prac_nltk.corpus import treebank
    from prac_nltk import treetransforms
    from prac_nltk import induce_pcfg
    from prac_nltk.parse import pchart
